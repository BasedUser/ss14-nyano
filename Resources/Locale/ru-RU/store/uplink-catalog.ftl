# Weapons
uplink-pistol-mk58-name = МК58
uplink-pistol-mk58-desc = Дешевое, повсеместно распространенное личное оружие, производимое дочерней компанией Нанотрайзен. Использует автоматические патроны калибра .35.
...
uplink-kanabou-name = Канабу
uplink-kanabou-desc = Оружие для тех, кто хочет отказаться от хитрости. Особенно подходит Они.
uplink-rickenbacker4001-name = Rickenbacker 4001
uplink-rickenbacker4001-desc = Когда дело доходит до этого, очень мало людей, которые будут махать битой.
# Explosives
...
uplink-emp-grenade-name = Импульсная граната
uplink-emp-grenade-desc = Выпускает электромагнитные импульсы, которые разрушают или повреждают многие электронные устройства или разряжают элементы питания.
uplink-exploding-pen-name = Взрывная ручка
uplink-exploding-pen-desc = Взрывное устройство класса IV, содержащееся в стандартной ручке. Поставляется с 4-секундным предохранителем.
# Ammo
...
uplink-encryption-key-desc = Два ключа шифрования для доступа к секретной частоте наших спецагентов. Отдайте лишний другу, но следите, чтобы он не попал в руки противника.
...
uplink-radio-jammer-desc = Это устройство будет прерывать любую исходящую радиосвязь поблизости при активации.
# Implants
...
uplink-rigged-boxing-gloves-name = Модифицированные боксерские перчатки
...
uplink-revolver-cap-gun-fake-name = Поддельный игрушечный пистолет
uplink-revolver-cap-gun-fake-desc = Обмани своего врага! Он может использовать как капсюльные, так и магнумовые пули. Поставляется с пулями магнум.
...
uplink-chimp-ammo-name = Коробка из 10 картриджей Омега.
uplink-chimp-ammo-desc = Коробка с 10 картриджами с омега-частицами для CHIMP. Омега-частицы вызывают сильные ожоги и делают аномалии супернестабильными.
...
uplink-stimpack-desc = Легендарное химическое вещество, производимое Донк Ко. для Синдиката. После введения внутрь увеличит вашу скорость бега и позволит быстрее восстанавливаться после оглушения в течение 5 минут.
uplink-stimkit-name = Стимкит
uplink-stimkit-desc = Аптечка, содержащая 6 микроинъекторов стимуляторов, каждый из которых вводит вам достаточное количество стимуляторов, которых хватит на минуту.
uplink-experimental-stimpack-name = Экспериментальный стимулятор
uplink-experimental-stimpack-desc = Прототип стимулятора, снятый с продажи из-за крайне вредных побочных эффектов. Эффекты включают виртуальный иммунитет к оглушению, значительно увеличенную скорость передвижения и быструю регенерацию тканей, но химическое вещество будет постоянно отравлять вас, пока оно находится в вашем кровотоке.
...
uplink-nocturine-gland-injector-name = Железа для введения Ноктюрина
uplink-nocturine-gland-injector-desc = Заставляет ваши клыки вводить ноктюрин всякий раз, когда вы сосете кровь.
# Pointless
