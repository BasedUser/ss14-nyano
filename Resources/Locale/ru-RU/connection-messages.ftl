...
ban-banned-permanent-appeal = Этот запрет будет снят только через апелляцию. Вы можете обратиться в { $link }
...
ban-banned-3 = Попытки обойти этот запрет, такие как создание новой учетной записи, будут регистрироваться.
...
panic-bunker-no-admins =
    Нет администраторов, и ваша учетная запись новая для нас.
    К сожалению, чтобы обеспечить качество игры, мы вынуждены отклонить это соединение.
    Если вы заинтересованы в Nyanotrasen, наш Discord.