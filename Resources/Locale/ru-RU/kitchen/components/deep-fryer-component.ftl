...
deep-fryer-window-title = фритюра
deep-fryer-label-baskets = Корзинки
deep-fryer-label-oil-level = Уровень масла
deep-fryer-label-oil-purity = Чистота масла
deep-fryer-button-insert-item = Вставить
deep-fryer-button-insert-item-tooltip = Вставить предмет в одну из корзинок фритюры.
deep-fryer-button-scoop-vat = Вычерпнуть из чана
deep-fryer-button-scoop-vat-tooltip = Вычерпнуть немного жидкости из чана с маслом. Необходимо держать жидкостный контейнер.
deep-fryer-button-clear-slag = Вычистить шлак
deep-fryer-button-clear-slag-tooltip = Очистить чан с маслом, вынув шлак. Необходимо держать жидкостный контейнер.
deep-fryer-button-remove-all-items = Извлечь все предметы
deep-fryer-button-remove-all-items-tooltip = Извлечь все предметы из корзинок фритюры.
