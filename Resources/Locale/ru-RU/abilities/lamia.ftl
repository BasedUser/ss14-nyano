...
bloodsucker-fail-not-blood = У { CAPITALIZE(SUBJECT($target)) } нету вкусной, утоляющей крови.
bloodsucker-fail-no-blood = У { CAPITALIZE(SUBJECT($target)) } не осталось крови.
...
bloodsucked-health-examine = [color=red]У { CAPITALIZE(SUBJECT($target)) } есть видные следы укусов на { POSS-ADJ($target) } шее.[/color]
